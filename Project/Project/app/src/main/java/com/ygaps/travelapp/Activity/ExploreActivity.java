...
import com.ygaps.travelapp.APIConnect.LocationStopPoint;
...
import com.ygaps.travelapp.APIConnect.SuggestDescObjectResponse;
import com.ygaps.travelapp.APIConnect.SuggestDescRequest;
import com.ygaps.travelapp.APIConnect.SuggestDescResponse;
import com.ygaps.travelapp.Adapter.MyAdapterCommentService;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.navigation_Notifications:
                        String Token5 = getIntent().getStringExtra("token");
                        overridePendingTransition(0, 0);
                        Intent intent5 = new Intent(ExploreActivity.this, NotificationActivity.class);
                        intent5.putExtra("token",Token5);

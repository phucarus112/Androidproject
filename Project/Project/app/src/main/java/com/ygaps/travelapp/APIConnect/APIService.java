...
public interface APIService {
    ...
    @FormUrlEncoded
    Call<ResponseBody> Registerfirebase( @Header("Authorization") String token,@Field("fcmToken") String fcmToken, @Field("deviceId") String deviceId,@Field("platform") Integer platform,@Field("appVersion") String appVersion );
    @GET("/tour/get/invitation")
    Call<InivationResponse> getInvation(@Header("Authorization") String token,@Query("pageIndex") int n,@Query("pageSize") int m);
    @POST("/tour/response/invitation")
    @FormUrlEncoded
    Call<ResponseBody> ResponseInivation( @Header("Authorization") String token,@Field("tourId") String tourId, @Field("isAccepted") Boolean isAccepted );
    @POST("/tour/add/review")
    @FormUrlEncoded
    Call<ResponseBody> ReviewTour( @Header("Authorization") String token,@Field("tourId") Integer tourId, @Field("point") Integer point,@Field("review") String rv );
    @POST("/user/notification/remove-token")
    @FormUrlEncoded
    Call<ResponseBody> DeleteRegister( @Header("Authorization") String token,@Field("fcmToken") String fcmToken, @Field("deviceId") String deviceId);
